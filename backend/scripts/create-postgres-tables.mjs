...
const result = await pool.query(
  "SELECT table_name FROM information_schema.tables WHERE table_schema = 'public' AND table_name IN ('t_users', 't_jobs', 't_applications', 't_templates') ORDER BY table_name"
);
